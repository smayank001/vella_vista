  ...
  return (
    <>
        ...
        <div className="container-editorial">
          <motion.div {...fadeIn} className="max-w-3xl mx-auto text-center">
            ...
            <h2 className="font-serif text-4xl md:text-5xl font-light mb-6">
              A Celebration As Unique As You
            </h2>
      ...
      <section className="section-padding">
        <div className="container-editorial">
          <SectionHeading
            editorial="Tailored to your vision"
            title="Wedding Packages"
            subtitle="All-inclusive experiences designed to make your celebration effortless and extraordinary."
          />
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {[
              ...
              <Link
                key={link.path}
                to={link.path}
                className="border border-border text-foreground px-6 py-2.5 text-xs font-sans font-medium tracking-widest uppercase hover:border-primary hover:text-primary transition-all"
              >
                {link.label}
              </Link>
            ))}
