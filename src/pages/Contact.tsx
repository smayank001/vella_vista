          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="grid sm:grid-cols-2 gap-5">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full border border-border bg-transparent px-4 py-3 font-sans text-sm focus:outline-none focus:border-primary transition-colors"
                      maxLength={100}
                    />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows={5}
                    className="w-full border border-border bg-transparent px-4 py-3 font-sans text-sm focus:outline-none focus:border-primary transition-colors resize-none"
                    maxLength={1000}
                  />
                </div>
                <button
            ...
            >
              ...
              <div className="space-y-4 font-sans text-muted-foreground mb-8">
                ...
                <p>
                  <a
                    href="mailto:info@vallevista.com"
                    className="text-foreground hover:text-primary transition-colors"
                  >
                    info@vallevista.com
                  </a>
                </p>
                <p className="text-editorial text-primary text-lg">
                  We LOVE to text!
                </p>
              </div>
